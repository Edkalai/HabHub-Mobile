 ...
 * @author tarek
 */
public class MatingDogsForm extends BaseForm{
     Form current;
    
    public MatingDogsForm(Resources res){
  ...
  swipe.setUIID("Container");
        ...
        ArrayList<AnnonceProprietaireChien>list = ServiceAnnonceProprietaireChien.getInstance().displayMating();
             int i = 0;
